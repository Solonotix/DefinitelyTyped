...
export type BluetoothCommand =
    | BluetoothHandleRequestDevicePrompt
    | BluetoothSimulateAdapter
    | BluetoothDisableSimulation
    | BluetoothSimulatePreconnectedPeripheral
    | BluetoothSimulateAdvertisement
    | BluetoothSimulateGattConnectionResponse
    | BluetoothSimulateGattDisconnection
    | BluetoothSimulateService
    | BluetoothSimulateCharacteristic
    | BluetoothSimulateCharacteristicResponse
    | BluetoothSimulateDescriptor
    | BluetoothSimulateDescriptorResponse;
export interface BluetoothHandleRequestDevicePrompt {
    method: 'bluetooth.handleRequestDevicePrompt';
    params: BluetoothHandleRequestDevicePromptParameters;
}
export type BluetoothHandleRequestDevicePromptParameters =
    & (BluetoothHandleRequestDevicePromptAcceptParameters | BluetoothHandleRequestDevicePromptCancelParameters)
    & {
        context: string;
...
export class Bluetooth {
    ...
    onRequestDevicePromptUpdated(
        callback: (params: BluetoothRequestDevicePromptUpdatedParameters) => void,
    ): Promise<void>;
