...
import type { EmptyResult, Extensible, JsUint } from './common.js';
...
export type ScriptResult =
    ...
    | ScriptRemovePreloadScriptResult;
...
export function getScriptManagerInstance(driver: unknown): Promise<Script>;
export class Script {
    private readonly bidi;
    private constructor();
    static create(driver: unknown): Promise<Script>;
    addPreloadScript(params: ScriptAddPreloadScriptParameters): Promise<ScriptAddPreloadScriptResult>;
    callFunction(params: ScriptCallFunctionParameters): Promise<ScriptCallFunctionResult>;
    disown(params: ScriptDisownParameters): Promise<void>;
    evaluate(params: ScriptEvaluateParameters): Promise<ScriptEvaluateResult>;
    getRealms(params: ScriptGetRealmsParameters): Promise<ScriptGetRealmsResult>;
    removePreloadScript(params: ScriptRemovePreloadScriptParameters): Promise<void>;
    onMessage(callback: (params: ScriptMessageParameters) => void): Promise<void>;
    onRealmCreated(callback: (params: ScriptRealmInfo) => void): Promise<void>;
    onRealmDestroyed(callback: (params: ScriptRealmDestroyedParameters) => void): Promise<void>;
    getAllRealms(): Promise<ScriptGetRealmsResult>;
    getRealmsByType(type: ScriptRealmType): Promise<ScriptGetRealmsResult>;
    getRealmsInBrowsingContext(context: BrowsingContextBrowsingContext): Promise<ScriptGetRealmsResult>;
    ...
    callFunctionInRealm(
        ...
        functionDeclaration: string,
        awaitPromise: boolean,
        args?: ScriptLocalValue[],
        resultOwnership?: ScriptResultOwnership,
        serializationOptions?: ScriptSerializationOptions,
        userActivation?: boolean,
    ): Promise<ScriptEvaluateResult>;
    callFunctionInBrowsingContext(
        browsingContextId: BrowsingContextBrowsingContext,
        functionDeclaration: string,
        awaitPromise: boolean,
        args?: ScriptLocalValue[],
        sandbox?: string,
    ...
    disownRealmScript(realmId: ScriptRealm, handles: ScriptHandle[]): Promise<void>;
