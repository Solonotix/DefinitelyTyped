import type { BrowserUserContext } from './browser.js';
import type { BrowsingContextBrowsingContext, BrowsingContextNavigation } from './browsing_context.js';
import type { EmptyResult, Extensible, JsInt, JsUint } from './common.js';
import type { ScriptStackTrace } from './script.js';
...
export type NetworkResult =
    | NetworkAddDataCollectorResult
    | NetworkAddInterceptResult
    | NetworkContinueRequestResult
    | NetworkContinueResponseResult
    | NetworkContinueWithAuthResult
    | NetworkDisownDataResult
    | NetworkFailRequestResult
    | NetworkGetDataResult
    | NetworkProvideResponseResult
    | NetworkRemoveDataCollectorResult
    | NetworkRemoveInterceptResult
    | NetworkSetCacheBehaviorResult
...
export type NetworkContinueWithAuthParameters =
    & (NetworkContinueWithAuthCredentials | NetworkContinueWithAuthNoCredentials)
    & {
        request: NetworkRequest;
    };
...
export function getNetworkInstance(driver: unknown): Promise<Network>;
export class Network {
    private readonly bidi;
    private constructor();
    static create(driver: unknown): Promise<Network>;
    addDataCollector(params: NetworkAddDataCollectorParameters): Promise<NetworkAddDataCollectorResult>;
    addIntercept(params: NetworkAddInterceptParameters): Promise<NetworkAddInterceptResult>;
    continueRequest(params: NetworkContinueRequestParameters): Promise<void>;
    continueResponse(params: NetworkContinueResponseParameters): Promise<void>;
    continueWithAuth(params: NetworkContinueWithAuthParameters): Promise<void>;
    /** @deprecated Pass a NetworkContinueWithAuthParameters object instead — will be removed in a future major version. */
    continueWithAuth(requestId: NetworkRequest, username: string, password: string): Promise<void>;
    disownData(params: NetworkDisownDataParameters): Promise<void>;
    failRequest(params: NetworkFailRequestParameters): Promise<void>;
    getData(params: NetworkGetDataParameters): Promise<NetworkGetDataResult>;
    provideResponse(params: NetworkProvideResponseParameters): Promise<void>;
    removeDataCollector(params: NetworkRemoveDataCollectorParameters): Promise<void>;
    removeIntercept(params: NetworkRemoveInterceptParameters): Promise<void>;
    setCacheBehavior(params: NetworkSetCacheBehaviorParameters): Promise<void>;
    setExtraHeaders(params: NetworkSetExtraHeadersParameters): Promise<void>;
    onAuthRequired(callback: (params: NetworkAuthRequiredParameters) => void): Promise<void>;
    onBeforeRequestSent(callback: (params: NetworkBeforeRequestSentParameters) => void): Promise<void>;
    onFetchError(callback: (params: NetworkFetchErrorParameters) => void): Promise<void>;
    onResponseCompleted(callback: (params: NetworkResponseCompletedParameters) => void): Promise<void>;
    onResponseStarted(callback: (params: NetworkResponseStartedParameters) => void): Promise<void>;
    cancelAuth(requestId: NetworkRequest): Promise<void>;
    continueWithAuthNoCredentials(requestId: NetworkRequest): Promise<void>;
    /** @deprecated Use {@link onBeforeRequestSent} instead — will be removed in a future major version. */
    beforeRequestSent(callback: (params: NetworkBeforeRequestSentParameters) => void): Promise<void>;
    /** @deprecated Use {@link onAuthRequired} instead — will be removed in a future major version. */
    authRequired(callback: (params: NetworkAuthRequiredParameters) => void): Promise<void>;
    /** @deprecated Use {@link onFetchError} instead — will be removed in a future major version. */
    fetchError(callback: (params: NetworkFetchErrorParameters) => void): Promise<void>;
    /** @deprecated Use {@link onResponseCompleted} instead — will be removed in a future major version. */
    responseCompleted(callback: (params: NetworkResponseCompletedParameters) => void): Promise<void>;
    /** @deprecated Use {@link onResponseStarted} instead — will be removed in a future major version. */
    responseStarted(callback: (params: NetworkResponseStartedParameters) => void): Promise<void>;
}
