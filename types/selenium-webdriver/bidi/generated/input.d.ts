...
import type { ScriptSharedReference } from './script.js';
...
export function getInputInstance(driver: unknown): Promise<Input>;
export class Input {
    private readonly bidi;
    private constructor();
    static create(driver: unknown): Promise<Input>;
    performActions(params: InputPerformActionsParameters): Promise<void>;
    releaseActions(params: InputReleaseActionsParameters): Promise<void>;
    setFiles(params: InputSetFilesParameters): Promise<void>;
    onFileDialogOpened(callback: (params: InputFileDialogInfo) => void): Promise<void>;
    /** @deprecated Use {@link performActions} instead — will be removed in a future major version. */
    perform(browsingContextId: string, actions: InputSourceActions[]): Promise<void>;
