...
import type { EmptyParams, EmptyResult, Extensible } from './common.js';
...
export class Session {
    ...
    private constructor();
    static create(driver: unknown): Promise<Session>;
    end(): Promise<void>;
    new(params: SessionNewParameters): Promise<SessionNewResult>;
    status(): Promise<SessionStatusResult>;
    subscribe(params: SessionSubscribeParameters): Promise<SessionSubscribeResult>;
    unsubscribe(params: SessionUnsubscribeParameters): Promise<void>;
}
